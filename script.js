...
const updateGame = (p1,p2,gameState) => {
  ...
  if(p1.health <= 0 || p2.health <=0){
    ...
    resultDiv = game.declareWinner(gameState,p1,p2) 
  }
}
...
class Player {
  ...
  heal (player) {
    ...
    let randd = Math.floor(Math.random() * 5) + 1 
...
let player1 = new Player("abdullah",100,5)
let player2 = new Player("rafay",100,10)
...
let simulate = document.getElementById('play')
